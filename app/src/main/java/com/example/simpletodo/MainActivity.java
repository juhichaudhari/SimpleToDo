...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        if (resultCode == RESULT_OK && requestCode == EDIT_TEXT_CODE) {
            ...
            // extract the original position of the edited item from theposition
            ...
            //persist the change
            saveItems();
            Toast.makeText(getApplicationContext(), "Item updated successful", Toast.LENGTH_SHORT).show();
    ...
    private void saveItems(){
        try {
            ...
            Log.e("mMainActivity", "Error writing items", e);
        }
    }
